  ...
  return (
    <div className=" w-full">
      <div className="font-medium mx-2 sm:mx-[80px] text-sm flex flex-row justify-between items-center text-[#000000] rounded-4xl">
        ...
        <div className="h-9 md:h-10 w-32 md:w-36 rounded-4xl bg-[#363636] text-[#FAFAFA] border border-[#000000] text-center flex justify-center items-center mr-2 md:mr-0">
